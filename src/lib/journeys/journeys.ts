...
export const JOURNEYS: Journey[] = [
  ...
  // ============================ Create an SOP ============================
  {
    ...
    steps: [
      ...
      { id: 'ai', type: 'screen', label: 'AI Settings', route: '/admin/ai-settings', detail: 'Per-organisation AI model overrides (parse pipeline) + read-only view of every env-managed model.' },
