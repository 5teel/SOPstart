...
export const JOURNEYS: Journey[] = [
  ...
  // ============================ Create an SOP ============================
  {
    ...
    steps: [
      ...
      { id: 'sops', type: 'screen', label: 'SOP management', route: '/admin/sops', detail: 'The Governance nav item deep-links /admin/sops?view=attention (the folded needs-attention view lands with UX-03).' },
      { id: 'blocks', type: 'screen', label: 'Block library', route: '/admin/blocks' },
      { id: 'team', type: 'screen', label: 'Team management', route: '/admin/team' },
      { id: 'settings', type: 'screen', label: 'Settings hub', route: '/admin/settings', detail: 'Groups AI Settings, Departments, and the AI agent layer under one home.' },
